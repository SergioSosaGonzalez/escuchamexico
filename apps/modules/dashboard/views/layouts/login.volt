...
<head>
    ...
    <link rel="stylesheet" href="{{url('dash/css/bootstrap.css')}}">
    <link rel="stylesheet" type="text/css" id="theme" href="{{url('dash/css/login.css')}}"/>
    <link rel="stylesheet" type="text/css" id="theme" href="{{url('dash/css/font-awesome.min.css')}}"/>
    <link rel="stylesheet" type="text/css" id="theme" href="{{url('dash/css/font-awesome.css')}}"/>
