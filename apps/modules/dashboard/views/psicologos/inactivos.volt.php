                    ...
                    <div class="table-responsive" style="text-align: center">
                        <table id="myTable" class="table table-hover table-actions generalDT" data-order="4" data-filter="asc">
                            ...
                            <tr id="<?=$cnv->getIdPsicologo()?>">
                                ...
                                <td>
                                    <button type="button" id="bDelete" data-cedula="<?=$cnv->getIdPsicologo()?>" data-toggle="modal" data-target="#myModal" class="btn btn-default btn-rounded btn-sm"><span class="fa fa-pencil"></span></button>
                                </td>
                            </tr>
                            </tbody>
                            <?php endforeach;?>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="bUpdateStatus" class="btn btn-primary">Cambiar estado</button>
            </div>
        </div>
    </div>
</div>